...
const DebitContent = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      ...
      try {
        ...
        const userTransactions = await getDocuments<DebitTransaction>('debitTransactions', constraints);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add to Firestore
      const docId = await createDocument('debitTransactions', newTransaction);
    ...
    return (
      <div className={styles.container}>
        <div className={styles.messageCard}>
          <h2>Please Login</h2>
          <p>You need to be logged in to view and manage your debit transactions.</p>
        </div>
      </div>
    );
  }
    ...
    <div className={styles.container}>
      <div className={styles.contentWrapper}>
        <div className={styles.transactionsSection}>
          <h2 className={styles.sectionTitle}>Your Debit Transactions</h2>
          ...
          {loading ? (
            ...
            <div className={styles.emptyState}>
              <p>You don't have any debit transactions yet.</p>
